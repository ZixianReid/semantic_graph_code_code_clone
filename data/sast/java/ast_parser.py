...
class ASTParser():
    ...
    def __init__(self, language: str = None, lib_path: str = None) -> None:
        ...
        if self.language == None:
            log.debug('Cannot find language configuration, adapting java as default language.')
            self.language = 'java'
        if self.lib_path == None:
            log.debug('Cannot find Language Library, adapting `my-language.so` generated by run `ts_build` as default.')
