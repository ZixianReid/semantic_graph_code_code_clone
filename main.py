...
def main():
    ...
    parser.add_argument('--config', default='/home/zixian/PycharmProjects/semantic_graph_code_code_clone/configs/benchmark_without_value_GMN/BCB/AST_GMN_BCB.json')
